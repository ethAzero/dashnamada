...
async function getResultBlockHash(id: string): Promise<ResultResponse> {
  const res = await fetch(
            ...
            <Table className="border table-fixed">
              <TableBody>
                ...
                <TableRow>
                  ...
                  <TableCell>:</TableCell>
                  <TableCell className="break-words">{dataTx.hash}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>Block Hash</TableCell>
                  <TableCell>:</TableCell>
                  <TableCell className="break-words">{dataBlockByTxId.block_id}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell>Height</TableCell>
                  <TableCell>:</TableCell>
                  <TableCell className="break-words">{dataBlockByTxId.header.height}</TableCell>
                </TableRow>
                <TableRow>
