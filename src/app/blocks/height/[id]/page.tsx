...
async function BlockByHeight(id: string) {
...
export default async function Blocks({
  ...
  const dataBlockByHeight = await BlockByHeight(params.id);
            ...
            <Table className="border table-fixed">
              <TableBody>
                <TableRow>
                  ...
                  <TableCell className=" w-[83%] text-left text-wrap">{dataBlockByHeight.header.chain_id}</TableCell>
                </TableRow>
                <TableRow>
                  ...
                  <TableCell className="break-words">
                    <Link
                      ...
                      href={`/blocks/height/${dataBlockByHeight.header.height}`}
                    >
                      <Link2Icon className="inline-flex mr-1"></Link2Icon>{dataBlockByHeight.header.height}
                    </Link>
                    </TableCell>
                </TableRow>
                <TableRow>
                  ...
                  <TableCell>:</TableCell>
                  <TableCell className="break-words">{dataBlockByHeight.header.time}</TableCell>
                </TableRow>
                <TableRow>
                  ...
                  <Link
                      className="justify-between hover:text-primary dark:hover:text-darkmode-primary"
                      href={`/blocks/hash/${dataBlockByHeight.block_id}`}
                    >
                      <Link2Icon className="inline-flex mr-1"></Link2Icon>{dataBlockByHeight.block_id}
                    </Link>  
                  </TableCell>
                </TableRow>
                <TableRow>
                  ...
                  <TableCell>:</TableCell>
                  <TableCell className="break-words">{dataBlockByHeight.header.proposer_address}</TableCell>
                </TableRow>
                <TableRow>
                  <TableCell className="align-top">Transaction</TableCell>
                  <TableCell className="align-top">:</TableCell>
                  <TableCell className="break-words">
                    Tx Count : {dataBlockByHeight.tx_hashes.length} 
